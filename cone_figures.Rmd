...
R0s_to_plot = unique(trajectories$R0) #c(0.95, 1.25, 4, 6.5)
sigmas_to_plot = unique(trajectories$sigma) #c(0.05, 0.25, 0.75, 0.95)
...
ggsave("figures/example_quadrants.png", quadrant_plot, height = 20, width = 20)
