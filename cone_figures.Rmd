...
jts1_1.05_0.1 <- read_csv("results/traj_stoc_1.05_0.1_1.csv")
jts2_1.05_0.1 <- read_csv("results/traj_stoc_1.05_0.1_2.csv")
jts3_1.05_0.1 <- read_csv("results/traj_stoc_1.05_0.1_3.csv")
jts4_1.05_0.1 <- read_csv("results/traj_stoc_1.05_0.1_4.csv")
jts5_1.05_0.1 <- read_csv("results/traj_stoc_1.05_0.1_5.csv")
jts6_1.05_0.1 <- read_csv("results/traj_stoc_1.05_0.1_6.csv")
jts7_1.05_0.1 <- read_csv("results/traj_stoc_1.05_0.1_7.csv")
jts8_1.05_0.1 <- read_csv("results/traj_stoc_1.05_0.1_8.csv")
jts9_1.05_0.1 <- read_csv("results/traj_stoc_1.05_0.1_9.csv")
jts10_1.05_0.1 <- read_csv("results/traj_stoc_1.05_0.1_10.csv")
...
jts_1.05_0.1_rolling <- jts_1.05_0.1 %>%
  group_by(traj) %>%
  mutate(
...
ggplot(jtd_1.05) +
 geom_line(data = jts_1.05_0.1_rolling,
