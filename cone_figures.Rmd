...
trajectories <- read_csv("results/illustrate_trajectories_proportionalSDE.csv") %>% # run "\code\julia\deterministic_results.jl" to get this file
  # ungroup() %>%
  filter(H >= 0, V >= 0) %>%
...
ggsave("figures/example_quadrants.png", quadrant_plot, height = 6, width = 8)
