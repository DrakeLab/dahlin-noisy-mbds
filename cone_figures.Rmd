...
ggplot(jtd_1.05)+geom_line(data=jts_1.05_0.1, aes(x=timestamp, y=value1, color=as.factor(traj)), alpha=0.8)+scale_color_viridis(discrete=TRUE)+theme_cowplot()+xlab('Time (days)')+ylab('Number of hosts infected')+geom_line(aes(x=timestamp, y=value1),lwd=1.5)+theme(legend.position="none")
...
ggplot(jtd_1.05)+geom_line(data=jts_1.05_0.4, aes(x=timestamp, y=value1, color=as.factor(traj)), alpha=0.8)+scale_color_viridis(discrete=TRUE)+theme_cowplot()+xlab('Time (days)')+ylab('Number of hosts infected')+geom_line(aes(x=timestamp, y=value1),lwd=1.5)+theme(legend.position="none")
...
ggplot(jtd_2)+geom_line(data=jts_2_0.1, aes(x=timestamp, y=value1, color=as.factor(traj)), alpha=0.8)+scale_color_viridis(discrete=TRUE)+theme_cowplot()+xlab('Time (days)')+ylab('Number of hosts infected')+geom_line(aes(x=timestamp, y=value1),lwd=1.5)+theme(legend.position="none")
...
ggplot(jtd_2)+geom_line(data=jts_2_0.4, aes(x=timestamp, y=value1, color=as.factor(traj)), alpha=0.8)+scale_color_viridis(discrete=TRUE)+theme_cowplot()+xlab('Time (days)')+ylab('Number of hosts infected')+geom_line(aes(x=timestamp, y=value1),lwd=1.5)+theme(legend.position="none")
