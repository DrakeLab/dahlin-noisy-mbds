...
ggsave('cones_beta.png', height = 7, width = 7)
```
...
plot_grid(p1, p2, p3, p4, p5, p6)
ggsave('cones_mV.png', height = 7, width = 7)
```
...
plot_grid(p1, p2, p3, p4, p5, p6)
ggsave('cones_Tvh.png', height = 7, width = 7)
```


#Trajectories
```{r} 
jtd_1.05 <- read_csv('julia_trajectories_1.05deterministic.csv')

jts1_1.05_0.1 <- read_csv('traj_stoc_1.05_0.1_1.csv')
jts2_1.05_0.1 <- read_csv('traj_stoc_1.05_0.1_2.csv')
jts3_1.05_0.1 <- read_csv('traj_stoc_1.05_0.1_3.csv')
jts4_1.05_0.1 <- read_csv('traj_stoc_1.05_0.1_4.csv')
jts5_1.05_0.1 <- read_csv('traj_stoc_1.05_0.1_5.csv')
jts6_1.05_0.1 <- read_csv('traj_stoc_1.05_0.1_6.csv')
jts7_1.05_0.1 <- read_csv('traj_stoc_1.05_0.1_7.csv')
jts8_1.05_0.1 <- read_csv('traj_stoc_1.05_0.1_8.csv')
jts9_1.05_0.1 <- read_csv('traj_stoc_1.05_0.1_9.csv')
jts10_1.05_0.1 <- read_csv('traj_stoc_1.05_0.1_10.csv')
jts1_1.05_0.1$traj <- 1
jts2_1.05_0.1$traj <- 4
jts3_1.05_0.1$traj <- 3
jts4_1.05_0.1$traj <- 2
jts5_1.05_0.1$traj <- 5
jts6_1.05_0.1$traj <- 6
jts7_1.05_0.1$traj <- 7
jts8_1.05_0.1$traj <- 8
jts9_1.05_0.1$traj <- 9
jts10_1.05_0.1$traj <- 10

jts_1.05_0.1 <- rbind(jts1_1.05_0.1, jts2_1.05_0.1, jts3_1.05_0.1, jts4_1.05_0.1, jts5_1.05_0.1, jts6_1.05_0.1, jts7_1.05_0.1, jts8_1.05_0.1, jts9_1.05_0.1, jts10_1.05_0.1)

jts_1.05_0.1 <- jts_1.05_0.1[jts_1.05_0.1$value2>=0,]
jts_1.05_0.1 <- jts_1.05_0.1[jts_1.05_0.1$value1>=0,]


```

```{r trajectories 1.05_0.1, out.width='100%', fig.align='center', fig.cap='\\label{fig:SDEtrajectories} For R0=1.25 and sigma=0.08, the number of hosts infected at each time period in deterministic solution (black line) and 5 stochastic solutions (colored lines) are plotted.'}
ggplot(jtd_1.05)+geom_line(data=jts_1.05_0.1, aes(x=timestamp, y=value1, color=as.factor(traj)), alpha=0.8)+scale_color_viridis(discrete=TRUE)+theme_cowplot()+xlab('Time (days)')+ylab('Number of hosts infected')+geom_line(aes(x=timestamp, y=value1),lwd=1.5)+theme(legend.position="none")+ggtitle('R0=1.05; sigma=0.1')

ggsave('trajectories_1.05_0.1.png', height = 7, width = 7)
```
```{r} 
jtd_1.05 <- read_csv('julia_trajectories_1.05deterministic.csv')

jts1_1.05_0.4 <- read_csv('traj_stoc_1.05_0.4_1.csv')
jts2_1.05_0.4 <- read_csv('traj_stoc_1.05_0.4_2.csv')
jts3_1.05_0.4 <- read_csv('traj_stoc_1.05_0.4_3.csv')
jts4_1.05_0.4 <- read_csv('traj_stoc_1.05_0.4_4.csv')
jts5_1.05_0.4 <- read_csv('traj_stoc_1.05_0.4_5.csv')
jts6_1.05_0.4 <- read_csv('traj_stoc_1.05_0.4_6.csv')
jts7_1.05_0.4 <- read_csv('traj_stoc_1.05_0.4_7.csv')
jts8_1.05_0.4 <- read_csv('traj_stoc_1.05_0.4_8.csv')
jts9_1.05_0.4 <- read_csv('traj_stoc_1.05_0.4_9.csv')
jts10_1.05_0.4 <- read_csv('traj_stoc_1.05_0.4_10.csv')
...
ggplot(jtd_1.05)+geom_line(data=jts_1.05_0.4, aes(x=timestamp, y=value1, color=as.factor(traj)), alpha=0.8)+scale_color_viridis(discrete=TRUE)+theme_cowplot()+xlab('Time (days)')+ylab('Number of hosts infected')+geom_line(aes(x=timestamp, y=value1),lwd=1.5)+theme(legend.position="none")+ggtitle('R0=1.05; sigma=0.4')

ggsave('trajectories_1.05_0.4.png', height = 7, width = 7)
```
```{r} 
jtd_2 <- read_csv('julia_trajectories_2deterministic.csv')

jts1_2_0.1 <- read_csv('traj_stoc_2_0.1_1.csv')
jts2_2_0.1 <- read_csv('traj_stoc_2_0.1_2.csv')
jts3_2_0.1 <- read_csv('traj_stoc_2_0.1_3.csv')
jts4_2_0.1 <- read_csv('traj_stoc_2_0.1_4.csv')
jts5_2_0.1 <- read_csv('traj_stoc_2_0.1_5.csv')
jts6_2_0.1 <- read_csv('traj_stoc_2_0.1_6.csv')
jts7_2_0.1 <- read_csv('traj_stoc_2_0.1_7.csv')
jts8_2_0.1 <- read_csv('traj_stoc_2_0.1_8.csv')
jts9_2_0.1 <- read_csv('traj_stoc_2_0.1_9.csv')
jts10_2_0.1 <- read_csv('traj_stoc_2_0.1_10.csv')
jts1_2_0.1$traj <- 1
jts2_2_0.1$traj <- 4
jts3_2_0.1$traj <- 3
jts4_2_0.1$traj <- 2
...
ggplot(jtd_2)+geom_line(data=jts_2_0.1, aes(x=timestamp, y=value1, color=as.factor(traj)), alpha=0.8)+scale_color_viridis(discrete=TRUE)+theme_cowplot()+xlab('Time (days)')+ylab('Number of hosts infected')+geom_line(aes(x=timestamp, y=value1),lwd=1.5)+theme(legend.position="none")+ggtitle('R0=2; sigma=0.1')

ggsave('trajectories_2_0.1.png', height = 7, width = 7)
```

```{r} 
jtd_2 <- read_csv('julia_trajectories_2deterministic.csv')

jts1_2_0.4 <- read_csv('traj_stoc_2_0.4_1.csv')
jts2_2_0.4 <- read_csv('traj_stoc_2_0.4_2.csv')
jts3_2_0.4 <- read_csv('traj_stoc_2_0.4_3.csv')
jts4_2_0.4 <- read_csv('traj_stoc_2_0.4_4.csv')
jts5_2_0.4 <- read_csv('traj_stoc_2_0.4_5.csv')
jts6_2_0.4 <- read_csv('traj_stoc_2_0.4_6.csv')
jts7_2_0.4 <- read_csv('traj_stoc_2_0.4_7.csv')
jts8_2_0.4 <- read_csv('traj_stoc_2_0.4_8.csv')
jts9_2_0.4 <- read_csv('traj_stoc_2_0.4_9.csv')
jts10_2_0.4 <- read_csv('traj_stoc_2_0.4_10.csv')
jts1_2_0.4$traj <- 1
jts2_2_0.4$traj <- 4
jts3_2_0.4$traj <- 3
jts4_2_0.4$traj <- 2
...
ggplot(jtd_2)+geom_line(data=jts_2_0.4, aes(x=timestamp, y=value1, color=as.factor(traj)), alpha=0.8)+scale_color_viridis(discrete=TRUE)+theme_cowplot()+xlab('Time (days)')+ylab('Number of hosts infected')+geom_line(aes(x=timestamp, y=value1),lwd=1.5)+theme(legend.position="none")+ggtitle('R0=2; sigma=0.4')

ggsave('trajectories_2_0.4.png', height = 7, width = 7)
```
