...
function combine_simulation_data(parm_grid, num_runs, num_trajectories)
  final_oprob = DataFrame([Vector{Union{Missing, Float64}}(missing, length(parm_grid)) for _ in 1:29],
  ["Thv", "sigma","prob_end_mean", "prob_end_25", "prob_end_75", "prob_out10_mean","prob_out10_25", "prob_out10_75", "prob_out100_mean","prob_out100_25", "prob_out100_75","max_cases_all_mean", 
  "max_cases_all_25", "max_cases_all_75", "max_cases_out_mean", "max_cases_out_25", "max_cases_out_75", "num_cases_mean","num_cases_25", "num_cases_75", 
  "end_time_mean", "end_time_25", "end_time_75", "end_time_out_mean", "end_time_out_25", "end_time_out_75",
  "time_max_mean", "time_max_25", "time_max_75"])
  ...
  for i in ProgressBar(1:length(parm_grid))
    ...
    final_oprob.sigma[i] = df_oprob.sigma[1]
    final_oprob.prob_end_mean[i] = df_oprob.prob_end_mean[1]
    final_oprob.prob_end_25[i] = df_oprob.prob_end_25[1]
    final_oprob.prob_end_75[i] = df_oprob.prob_end_75[1]
    final_oprob.prob_out10_mean[i] = df_oprob.prob_out10_mean[1]
    final_oprob.prob_out10_25[i] = df_oprob.prob_out10_25[1]
    final_oprob.prob_out10_75[i] = df_oprob.prob_out10_75[1]
    final_oprob.prob_out100_mean[i] = df_oprob.prob_out100_mean[1]
    final_oprob.prob_out100_25[i] = df_oprob.prob_out100_25[1]
    final_oprob.prob_out100_75[i] = df_oprob.prob_out100_75[1]
    final_oprob.max_cases_all_mean[i] = df_oprob.max_cases_all_mean[1]
    final_oprob.max_cases_all_25[i] = df_oprob.max_cases_all_25[1]
    final_oprob.max_cases_all_75[i] = df_oprob.max_cases_all_75[1]
    final_oprob.max_cases_out_mean[i] = df_oprob.max_cases_out_mean[1]
    final_oprob.max_cases_out_25[i] = df_oprob.max_cases_out_25[1]
    final_oprob.max_cases_out_75[i] = df_oprob.max_cases_out_75[1]
    final_oprob.num_cases_mean[i] = df_oprob.num_cases_mean[1]
    final_oprob.num_cases_25[i] = df_oprob.num_cases_25[1]
    final_oprob.num_cases_75[i] = df_oprob.num_cases_75[1]
    final_oprob.end_time_mean[i] = df_oprob.end_time_mean[1]
    final_oprob.end_time_25[i] = df_oprob.end_time_25[1]
    final_oprob.end_time_75[i] = df_oprob.end_time_75[1]
    final_oprob.end_time_out_mean[i] = df_oprob.end_time_out_mean[1]
    final_oprob.end_time_out_25[i] = df_oprob.end_time_out_25[1]
    final_oprob.end_time_out_75[i] = df_oprob.end_time_out_75[1]
    final_oprob.time_max_mean[i] = df_oprob.time_max_mean[1]
    final_oprob.time_max_25[i] = df_oprob.time_max_25[1]
    final_oprob.time_max_75[i] = df_oprob.time_max_75[1]
